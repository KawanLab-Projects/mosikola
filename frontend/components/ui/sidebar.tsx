...
function SidebarMenuSkeleton({
  ...
  // Use a stable fixed width on server; set a random width only after client mount
  // to avoid SSR/client hydration mismatch (Math.random() differs between server and client).
